...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'text', // 主题， 支持 ['next','hexo',"fukasawa','medium','example','matery','gitbook','simple'] @see https://preview.tangly1024.com
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '啥也不是', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://linghua.ml', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'lht@linghua.ml', // 邮箱地址 例如mail@tangly1024.com
